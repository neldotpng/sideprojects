          ...
          "Raymarching Spheres": folder(
            {
              ...
              "Color Presets": buttonGroup({
                1: () =>
                  set({
                    RSGC1: { x: 0.5, y: 0.5, z: 0.5 },
                    RSGC2: { x: 0.5, y: 0.5, z: 0.5 },
                    RSGC3: { x: 1.0, y: 1.0, z: 1.0 },
                    RSGC4: { x: 0.3, y: 0.2, z: 0.2 },
                  }),
                2: () =>
                  set({
                    RSGC1: { x: 0.49, y: 0.33, z: 0.63 },
                    RSGC2: { x: 1.0, y: 0.35, z: 0.52 },
                    RSGC3: { x: 1.0, y: 1.0, z: 1.0 },
                    RSGC4: { x: 0.3, y: 0.2, z: 0.2 },
                  }),
                3: () =>
                  set({
                    RSGC1: { x: 0.62, y: 0.31, z: 0.59 },
                    RSGC2: { x: 1, y: 1, z: 1 },
                    RSGC3: { x: 1.05, y: 1, z: 1 },
                    RSGC4: { x: 0.63, y: 0.5, z: 0.33 },
                  }),
              }),
            },
            { collapsed: true }
