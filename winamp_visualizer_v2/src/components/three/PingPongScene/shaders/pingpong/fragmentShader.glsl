...
void main() {
  ...
  if (mod(id.x, 9.) == 0. || mod(id.y, 9.) == 0.) color = pal((u00 + u01) / 2.);
  if (mod(id.x, 9.) == 1. || mod(id.y, 9.) == 1.) color = pal(u01);
  if (mod(id.x, 9.) == 2. || mod(id.y, 9.) == 2.) color = pal(u02);
  if (mod(id.x, 9.) == 3. || mod(id.y, 9.) == 3.) color = pal(u03);
  if (mod(id.x, 9.) == 4. || mod(id.y, 9.) == 4.) color = pal(u04);
  if (mod(id.x, 9.) == 5. || mod(id.y, 9.) == 5.) color = pal(u05);
  if (mod(id.x, 9.) == 6. || mod(id.y, 9.) == 6.) color = pal(u06);
  if (mod(id.x, 9.) == 7. || mod(id.y, 9.) == 7.) color = pal(u07);
  if (mod(id.x, 9.) == 8. || mod(id.y, 9.) == 8.) color = pal(u08 * 1.5);
